    ...
    <>
      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-1.5 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-0.5 ml-1">
                    ...
                    {/*  WhatsApp  */}
          <a className="w-8 h-8 flex items-center justify-center rounded-full bg-[#25D366] text-white transition-all duration-200 hover:scale-110 hover:brightness-110 shadow-sm"
          ...
          {/*  Instagram  */}
          <a className="w-8 h-8 flex items-center justify-center rounded-full bg-[#E1306C] text-white transition-all duration-200 hover:scale-110 hover:brightness-110 shadow-sm"
          ...
          {/*  LinkedIn  */}
          <a className="w-8 h-8 flex items-center justify-center rounded-full bg-[#0077b5] text-white transition-all duration-200 hover:scale-110 hover:brightness-110 shadow-sm"
          ...
          {/*  GitHub  */}
          <a className="hidden sm:flex w-8 h-8 items-center justify-center rounded-full bg-[#333] text-white transition-all duration-200 hover:scale-110 hover:brightness-125 shadow-sm"
    ...
    <header id="siteHeader" className="fixed left-0 right-0 z-50 transition-all duration-300 pt-3 pb-2"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="mainNav"
          ...
          style={{ boxShadow: "0 4px 24px rgba(0,0,0,.06), 0 1px 0 rgba(255,255,255,.8) inset, 0 -1px 0 rgba(148,163,184,.15) inset" }}>
          ...
          <Link className="flex items-center gap-3 group shrink-0" href="/">
            ...
            <div className="relative shrink-0">
              <div
                className="w-9 h-9 rounded-full overflow-hidden border-2 border-white/70 shadow-md transition-all duration-300 group-hover:border-primary/40 group-hover:shadow-[0_0_14px_rgba(242,13,70,0.30)] group-hover:scale-105">
            ...
            <div className="flex flex-col leading-none gap-0.5">
              <span
                className="text-[15px] font-extrabold tracking-tight bg-gradient-to-r from-slate-900 to-slate-600 group-hover:from-primary group-hover:to-rose-500 bg-clip-text text-transparent transition-all duration-400">Rishvin</span>
              <span
                className="text-[9px] font-bold tracking-[0.12em] uppercase text-slate-400 group-hover:text-primary/70 transition-colors duration-300">Portfolio
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {/*  ── Aurora "Let&apos;s Talk" CTA ──  */}
            <Link id="letsTalkBtn" href="/contact"
              className="hidden md:inline-flex items-center gap-2 px-4 py-2 text-[14px] font-bold text-white rounded-full shadow-md hover:-translate-y-0.5 hover:scale-105 transition-all duration-300 relative overflow-hidden group"
              style={{ background: "linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #7c0e27 100%)" }}>
              {/*  Aurora sweep shimmer  */}
              <span
                className="absolute inset-0 -translate-x-full skew-x-12 bg-gradient-to-r from-transparent via-white/25 to-transparent group-hover:translate-x-full transition-transform duration-700 ease-out pointer-events-none"></span>
              {/*  Gradient border ring on hover  */}
              <span
                className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                style={{ background: "linear-gradient(135deg, #f20d46 0%, #818cf8 50%, #f20d46 100%)", mask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)", WebkitMaskComposite: "xor", maskComposite: "exclude", padding: "1.5px" }}></span>
